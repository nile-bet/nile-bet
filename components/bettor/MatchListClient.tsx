  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="flex flex-1 min-h-0 gap-2 px-2 pb-2">
        {/* League Sidebar */}
        <div className="hidden md:flex flex-col flex-shrink-0 rounded-xl overflow-hidden border border-nile-blue/20" style={{ height: "calc(100vh - 70px)", overflowY: "auto" }}>
          <LeagueSidebar
            countries={countries}
        ...
        {/* Match List */}
        <div className="flex-1 overflow-y-auto overscroll-auto rounded-xl border border-nile-blue/20" style={{ height: "calc(100vh - 70px)" }}>
          {/* Column headers */}
